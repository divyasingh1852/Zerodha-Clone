import React, { useState, useEffect, useContext } from "react";   //hook-useEffect to connect with API
...
const Holdings = () => {
  ...
  useEffect(() => {
    setAllHoldings(holdings); // Ensures UI reflects the latest holdings
  }, [holdings]);
